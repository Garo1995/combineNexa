...
let AiHeroSwiper = new Swiper(".ai-photoshoot-swiper", {
  spaceBetween: 10,
  slidesPerView: 3,
  loop: true,
  centeredSlides: true,
  ...
  breakpoints: {
    ...
    400: { slidesPerView: 2.2, spaceBetween: 8 },
    600: { slidesPerView: 2.5 },
    700: { slidesPerView: 3 },
    800: { slidesPerView: 4 },
    1000: { slidesPerView: 5, spaceBetween: 10 },
    1399: { slidesPerView: 5.3, spaceBetween: 10 },
  },
});
...
let creativitySwiper;

function initCreativitySwiper() {
  const isMobile = window.innerWidth < 1020;

  if (creativitySwiper) {
    creativitySwiper.destroy(true, true);
  }

  creativitySwiper = new Swiper(".creativity-slider", {
    speed: 800,
    slidesPerGroup: 1,
...
initCreativitySwiper();
window.addEventListener("resize", initCreativitySwiper);
...
const AiReviewsSlider = new Swiper('.ai-reviews-slider', {
  slidesPerView: 3,
  spaceBetween: 10,

  allowTouchMove: false,   // отключает свайп
  simulateTouch: false,    // на всякий
  grabCursor: false,
